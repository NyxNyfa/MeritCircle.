...
async function main() {
  ...
  const pools = [
    ...
    { poolIdOnChain: 2, name: 'Growth Pool', poolSize: 5, contributionAmount: 200, tierRequired: 2, totalYield: 1000, isAuctionMode: false },
    { poolIdOnChain: 3, name: 'Trusted Pool', poolSize: 10, contributionAmount: 100, tierRequired: 3, totalYield: 1000, isAuctionMode: false },
    { poolIdOnChain: 4, name: 'Elite Pool', poolSize: 5, contributionAmount: 100, tierRequired: 4, totalYield: 500, isAuctionMode: true },
    { poolIdOnChain: 5, name: 'Prime Pool', poolSize: 5, contributionAmount: 500, tierRequired: 5, totalYield: 2500, isAuctionMode: true },
  ]
